...
# Get current OS to avoid errors in path
...
if(os == "windows"):
    ...
    datasets = h5py.File('RadarData/160930/20/30/merged/nldbl_pvol_20160930T2030Z.h5', 'r')
...
if(os == "windows"):
    with open(r'testData\complete.csv', 'w') as csvfile:
